...
namespace VeterLab.Controllers
{
    public class DetallesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Folio,FechaRecepcion,FechaEntrega,Rut,Nombre,CantidadMuestras")] Detalle detalle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Folio,FechaRecepcion,FechaEntrega,Rut,Nombre,CantidadMuestras")] Detalle detalle)
        {
            if (ModelState.IsValid)
            {
